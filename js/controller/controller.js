angular
	...
	.controller('catalogoCtrl', function($scope){
		...
		{
			'categoria': 'Papeleria',
			'image' : 'img/conectatejd.jpeg',
			'nombreNegocio': 'Conectate JD',
			'descripcion': 'Papeleria, tecnologia, escolar, oficina, impresiones, y más, ',
			'domicilio' : '-',
			'Telefono': '313 7205795',
			'Telefono2': '',
		},
		{
			'categoria': 'Perfumeria',
			'image' : 'img/venus.jpeg',
			'nombreNegocio': 'Venus perfumeria',
			'descripcion': 'Todas las marcas de perfumes, gel antibacterial, y más',
			'domicilio' : 'Gratis',
			'Telefono': '304 5380331',
			'Telefono2': '',
		},
		{
			'categoria': 'Tienda',
